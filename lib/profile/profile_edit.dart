...
//     _selectedSemester = userProfile.semester;
...
//       print("Fetched semesters: $semesters");
...
//         );
//         print("Going back...");
//         // Get.back(result: true);   // Didn't worked GetX, I don't know why, it should have worked since I used Get.to() in profile page, but it didn't. So I used Navigator.pop() instead.
...
//     if (nowEditing) {
//       // Wait for the field to become editable (readOnly: false) before
//       // requesting focus, otherwise the keyboard may not show.
